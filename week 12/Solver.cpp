...
int main(int argc, char* argv[])
{
    ...
    f1.close();
    ofstream f2(argv[2]);
    LVOWDnPCF lcf (initial_state, params, dt);
    POWDnMCF mcf(initial_state, params, dt);
    RK4_method <LVOWDnPCF> RK4lcf(lcf, T);
    RK4_method <POWDnMCF> RK4mcf(mcf, T);
    json js2={};
    js2["RK4l"]=RK4lcf.result();
    js2["RK4m"]=RK4mcf.result();
    f2<<js2;
    f2.close();
